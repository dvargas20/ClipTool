...
class ClipTool:
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/cliptool/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Clip/Tool'),
            callback=self.run,
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(self.tr(u'&Clip/Tool'), action)
    ...
    def run(self):
        ...
        if result:
            # Retrieve file paths
            inputFile = self.dlg.inputShape.text()
            clipFile = self.dlg.clipShape.text()
